...
const BookingTicket = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                setMessage("Booking successful on " + visitDate + "and total amount is ₹" + (FIXED_TICKET_PRICE * Number(numVisitors)) + "");
                setPhone("");
                setNumVisitors("");
    ...
    const totalAmount = numVisitors ? FIXED_TICKET_PRICE * Number(numVisitors) : 0;
    ...
    return (
        <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded shadow">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    <label className="block mb-2 font-medium">Select type of visitor</label>
